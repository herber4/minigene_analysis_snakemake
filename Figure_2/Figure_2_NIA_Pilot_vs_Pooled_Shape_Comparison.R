...
pdf(file = "/Users/herber4/Desktop/Dissertation/chapter_three/figures/combined.pdf",
...
pdf(file = "/Users/herber4/Desktop/Dissertation/chapter_three/figures/Figure_One/WT_pilot_vs_WTpool_butterfly.pdf",
    height = 4, width = 6, paper = "letter")
shape %>%
  filter(source == "base_base") %>%
  ggplot(aes(x = as.factor(Nucleotide), y = Norm_profile)) +
  geom_col(fill = "#f1b6da") +
